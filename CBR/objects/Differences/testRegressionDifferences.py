...
CarPricesDataNumeric = CarPricesDataNumeric[CarPricesDataNumeric['priceDelta'] !=0]
# CarPricesDataNumeric = CarPricesDataNumeric[CarPricesDataNumeric['priceDelta'] <= 100000]
CarPricesDataNumeric.head()

# Separate Target Variable and Predictor Variables
TargetVariable=['priceDelta']
Predictors=['wohnflaeche', 'grundstueckflaeche', 'zimmer', 'basement', 'year', 'efficiency_rating', 'condition', 'category', 'kontextWert']
